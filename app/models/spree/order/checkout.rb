        ...
        klass.class_eval do
          ...
          def self.define_state_machine!
            ...
            state_machine :state, initial: :cart, use_transactions: false, action: :save_state do
              ...
              before_transition to: :address, do: :assign_default_credit_card
              before_transition to: :address, do: :create_proposed_shipments
              before_transition to: :address, do: :ensure_available_shipping_rates
              before_transition to: :address, do: :set_shipments_cost
              before_transition to: :address, do: :apply_free_shipping_promotions

              before_transition to: :complete, do: :create_tax_charge!
              before_transition to: :complete, do: :persist_user_address!
              before_transition to: :complete, do: :persist_user_credit_card
